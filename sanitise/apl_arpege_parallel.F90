...
#include "apl_arpege_mwave_parallel.intfb.h"
  ...
  CALL FIELD_NEW(YL_ZRDG_SOLO, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZRDG_CVGT, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZQCO2, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFCHQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZFLU_FEVI, UBOUNDS=(/ YDCPG_OPTS%KLON, YDMODEL%YRML_PHY_G%YRDPHY%NTSSG + 1, YDCPG_OPTS%KGPBLKS /),  &
  ...
  CALL FIELD_NEW(YL_ZFLU_CHN, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZKUROV2, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZECTCLS, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZUSLE, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZTKE1, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPRODTH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZKCLS, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFLX_LOTT_GWV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /),  &
  & LBOUNDS=(/ 1, 0, 1 /), PERSISTENT=.true.)
  ...
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFLX_LOTT_GWU, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /),  &
  & LBOUNDS=(/ 1, 0, 1 /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZBAY_QSCONV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /),  &
  & LBOUNDS=(/ 1, 1, 1 /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZBAY_QRCONV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /),  &
  & LBOUNDS=(/ 1, 1, 1 /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZDE2MR, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPRC_DPRECIPS, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%NDTPREC, YDCPG_OPTS%KGPBLKS /),  &
  & LBOUNDS=(/ 1, 1, 1 /), PERSISTENT=.true.)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:CPPHINP')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CPPHINP:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CPPHINP:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZRDG_SOLO, ZRDG_CVGQ, ZRDG_MU0N, ZRDG_MU0M,  &
!$ACC & ZRDG_MU0, ZRDG_MU0LU, ZRDG_CVGT, Z_YDVARS_GEOMETRY_GELAM_T0, Z_YDCPG_DYN0_CTY_EVEL, Z_YDVARS_V_T0,  &
!$ACC & Z_YDCPG_PHY0_XYB_RDELP, Z_YDVARS_Q_DM, Z_YDVARS_Q_DL, Z_YDVARS_U_T0, Z_YDVARS_T_DL, Z_YDVARS_CVGQ_DM,  &
!$ACC & Z_YDVARS_CVGQ_DL, Z_YDVARS_GEOMETRY_GEMU_T0, Z_YDVARS_Q_T0, Z_YDVARS_T_DM, Z_YDVARS_CVGQ_T0, ) PRIVATE( JBLK )  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ZRDG_LCVQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZRDG_LCVQ:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZRDG_LCVQ:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZQCO2, ZRDG_CVGQ, ZRDG_LCVQ, ZFLU_QSATS, )  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:APLPAR_INIT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:APLPAR_INIT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:APLPAR_INIT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFLU_CD, ZPFL_FTKEI, ZDSA_C2, ZPFL_FEFB2,  &
!$ACC & ZFLU_NEIJ, ZDSA_C1, ZMSC_FRMQ, ZPFL_FEFB1, ZMSC_LSCPE, ZMSC_LH, ZFLU_EMIS, ZFLU_QSAT, ZDSA_RS, ZMSC_QW, ZPFL_FEFB3,  &
!$ACC & ZFCHQ, IMOC_CLPH, ZFLU_CDN, ZPFL_FTKE, ZMSC_TW, ZDSA_LHS, ZFLU_QSATS, ZDSA_CPS, ZFLU_FEVI, ZFLU_VEG, ZFLU_CH,  &
!$ACC & ZFLU_CHN, Z_YDMF_PHYS_SURF_GSD_VF_PVEG, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:CHECKMV')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CHECKMV:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CHECKMV:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZRDG_MU0, Z_YDVARS_GEOMETRY_GELAM_T0,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_Q,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDVARS_GEOMETRY_GEMU_T0, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACTQSAT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACTQSAT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACTQSAT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZGEOSLC, ZMSC_LSCPE, ZMSC_LH, ZFLU_QSAT, ZMSC_QW,  &
!$ACC & ZMSC_TW, ZQV, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDCPG_MISC_RH, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACSOL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZCN, ZDSA_C2, ZNEIJV, ZDSA_C1, ZWWILT, ZWSMX,  &
!$ACC & ZCG, ZWPMX, ZWSEQ, ZWFC, ZNEIJG, ZC3, Z_YDMF_PHYS_SURF_GSD_VV_PD2, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PSAB, Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_OUT_CT,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL, Z_YDMF_PHYS_SURF_GSD_VV_PARG, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PIVEG, Z_YDMF_PHYS_SURF_GSD_VV_PLAI, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACHMTLS')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMTLS:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMTLS:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFLU_CD, ZPCLS, ZRTI, ZMRIPP, ZDPHIT, ZGWDCS,  &
!$ACC & ZDPHI, ZFLU_CDN, ZNBVNO, ZPRS, ZDSA_LHS, ZDSA_CPS, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  &
...
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_T, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_GZ0H, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACHMT')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZPFL_FPLCH, ZMRIPP, ZDQSTS, ZGWDCS, ZFLU_QSATS,  &
!$ACC & ZDSA_CPS, ZWFC, ZNEIJG, ZPCLS, ZHQ, ZFLU_CDN, ZCHROV, ZFLU_CD, ZFLU_CH, ZQV, ZPFL_FPLSH, ZNEIJV, ZXDROV, ZDPHIV,  &
!$ACC & ZHU, ZDSA_RS, ZXHROV, ZNBVNO, ZSTAB, ZCDROV, ZFLU_VEG, ZFLU_NEIJ, ZDPHIT, ZRTI,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_OUT_VGST, Z_YDMF_PHYS_OUT_NUCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_OUT_RHCLS, Z_YDMF_PHYS_OUT_TCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
!$ACC & Z_YDMF_PHYS_OUT_NVCLS, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, Z_YDMF_PHYS_SURF_GSD_VV_PHV,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  &
!$ACC & Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_QCLS, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_OUT_GZ0,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACCLPH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACCLPH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACCLPH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZTHETAV, ZCP, ZTHETAVS, IMOC_CLPH, ZUGST, ZQV,  &
!$ACC & ZBLH, ZVGST, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_OUT_VEIN, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:DIFTQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:DIFTQ:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:DIFTQ:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZDIFCVPPQ, ZEDMFU, ZDIFCVPPV, ZEDMFS, ZEDMFQ,  &
!$ACC & ZDIFCVPPS, ZDIFCVPPU, ZEDMFV, Z_YDMF_PHYS_OUT_STRTU, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS,  &
!$ACC & Z_YDMF_PHYS_OUT_STRTV, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_FRSOPT, Z_YDMF_PHYS_OUT_FRTH, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACDRAG')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRAG:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRAG:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFLU_NEIJ, ZFLU_EMIS, ZDQSTS, ZGWDCS, ZMSC_QW,  &
!$ACC & ZNBVNO, ZQLIS, ZTRAJGWD, ZNEBS, ZCHROV, ZQV, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDVARS_GEOMETRY_RCORI_T0, Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, Z_YDMF_PHYS_OUT_STRDU,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_FPEVPSL,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_FCSQL, Z_YDMF_PHYS_OUT_FPFPSL,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_STRDV, Z_YDMF_PHYS_OUT_FCSQN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSL, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_OUT_DRNSHF,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:TURBULENCE_PART2')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:TURBULENCE_PART2:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:TURBULENCE_PART2:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZKUROV2, ZECTCLS, ZPFL_FTKE, ZUSLE, ZTKE1,  &
!$ACC & ZPRODTH, ZKCLS, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFCS, Z_YDMF_PHYS_BASE_STATE_TKE, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_DIFCQ,  &
!$ACC & Z_YDMF_PHYS_OUT_STRCU, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_Q,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_EDR, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_OUT_STRCV, )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:QNGCOR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:QNGCOR:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:QNGCOR:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZQI, ZQV, ZPFL_FPLCH, ZSEDIQI, ZFLX_LOTT_GWV,  &
!$ACC & ZSEDIQL, ZPFL_FPLSH, ZQL, ZFPLSN, ZFPCOR, ZFLX_LOTT_GWU, ZFPLSL, Z_YDMF_PHYS_OUT_FPFPCN, Z_YDMF_PHYS_OUT_DIFTQN,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFCQ, Z_YDMF_PHYS_OUT_DIFTQL, Z_YDMF_PHYS_OUT_FCCQN, Z_YDMF_PHYS_OUT_FCCQL, Z_YDMF_PHYS_OUT_DIFCQL,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_FPEVPCL, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_FPLSL,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_DIFCQN, Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_OUT_FCQNG,  &
!$ACC & Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_OUT_FCSQL, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_FPFPCL,  &
!$ACC & Z_YDMF_PHYS_OUT_FCSQN, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_FPLSG, Z_YDMF_PHYS_OUT_FPEVPCN, ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACDRME')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRME:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRME:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZMSC_FRMQ, ZQV, Z_YDMF_PHYS_OUT_STRMU,  &
!$ACC & Z_YDMF_PHYS_OUT_FRMH, Z_YDMF_PHYS_OUT_STRMV, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDVARS_IRAD_T1,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDCPG_MISC_NEB, Z_YDMF_PHYS_BASE_STATE_T, Z_YDCPG_MISC_QICE, Z_YDVARS_A_T1,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDVARS_LRAD_T1, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_BASE_STATE_U, ) PRIVATE(  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACEVADCAPE')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACEVADCAPE:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACEVADCAPE:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZBLH, IMOC_CLPH, ZDCAPE, ZTKE1,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_OUT_CLPH,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_OUT_VGST,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_T, Z_YDVARS_GEOMETRY_OROG_T0, Z_YDMF_PHYS_OUT_UGST,  &
!$ACC & Z_YDMF_PHYS_OUT_CAPE, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACVISIH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACVISIH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACVISIH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZQR, ZQGM, ZQS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_VISICLD, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_OUT_MXCLWC, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_VISIHYD,  &
!$ACC & Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ZBAY_QRCONV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZBAY_QRCONV:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZBAY_QRCONV:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZBAY_QSCONV, ZBAY_QRCONV, Z_YDMF_PHYS_OUT_FPLCL,  &
...
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$ACC & Z_YDMF_PHYS_OUT_TPWCLS, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_I, Z_YDMF_PHYS_BASE_STATE_L, ) PRIVATE(  &
!$ACC & JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          ...
          & Z_YDMF_PHYS_SURF_GSD_VH_PPCL(:, JBLK), Z_YDMF_PHYS_SURF_GSD_VH_PPCN(:, JBLK),  &
          & Z_YDMF_PHYS_SURF_GSD_VH_PPSL(:, JBLK), Z_YDMF_PHYS_SURF_GSD_VH_PPSN(:, JBLK), YDSTACK=YLSTACK)
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:0')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:0:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:0:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_YDMF_PHYS_OUT_FPLCL,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VH_PPSL, Z_YDMF_PHYS_OUT_FEVL, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_FEVN,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VH_PPCL, Z_YDMF_PHYS_SURF_GSD_VH_PPSN, Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_OUT_FPLSN,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VH_PPCN, Z_YDMF_PHYS_SURF_GSD_VH_PEVA, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          ...
          CALL CPQSOL_OPENACC(YDMODEL%YRCST, YDGEOMETRY%YRDIMV, YDMODEL%YRML_PHY_MF%YRPHY, YDCPG_OPTS%KLON,  &
          & YLCPG_BNDS%KIDIA, YLCPG_BNDS%KFDIA, Z_YDCPG_PHY0_PREHYD(:, :, JBLK), Z_YDMF_PHYS_SURF_GSP_RR_PT_T0(:, JBLK),  &
          & Z_YDCPG_MISC_QS(:, JBLK), ZFLU_QSATS(:, JBLK), Z_YDCPG_MISC_QSOL(:, JBLK), YDSTACK=YLSTACK)
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:1')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:1:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:1:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFLU_QSATS, Z_YDCPG_MISC_QSOL,  &
!$ACC & Z_YDCPG_PHY0_PREHYD, Z_YDMF_PHYS_SURF_GSP_RR_PT_T0, Z_YDCPG_MISC_QS, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
